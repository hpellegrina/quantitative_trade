...
# bring csv
data <- read_csv("../output/results_forward_looking.csv", col_names=FALSE)
...
ggsave("../output/microregion_map_DpopSS_forward_looking.png", width = 8, height = 6, dpi = 300)
...
ggsave("../output/microregion_map_Dpop3_forward_looking.png", width = 8, height = 6, dpi = 300)
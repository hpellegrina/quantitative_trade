...
D_rincome_gft   = 100*((pi_cases(:,2)./pi_cases(:,1)).^(-1/theta).*(1./(T_cases(:,2)./T_cases(:,1)).^(-1/theta)) - 1);

figure(1)
scatter(log(D_rincome),log(D_rincome_gft));
